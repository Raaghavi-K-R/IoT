...
void setup()
{
  ...
  lcd.begin(16, 2);
  Serial.begin(9600);
  lcd.print("SMART HEALTH PROJECT");
  Serial.println("SMART HEALTH PROJECT");
  delay(3000);
  lcd.clear();
  lcd.setCursor(0, 0);
...
void loop()
{
  ...
  if (digitalRead(button_2) == HIGH)
  {
    ...
    else if (BMI2 >= 30 && BMI2 < 35)
    {
      ...
      lcd.print("OVERWEIGHT");
      Serial.println("MODERATELY OVERWEIGHT");
      delay(4000);
    }
    else if (BMI2 >= 35)
    {
    ...
    while (1)
    {
      ...
      for (i = current_time; i < (current_time + (86400)); i++)
      {
        ...
        else
        {
          ...
          Serial.println("Your medicine");
          lcd.setCursor(0, 1);
          lcd.print("time is after :");
          Serial.println("time is after :");
          delay(1000);
